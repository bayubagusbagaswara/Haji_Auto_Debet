...
VALUES (
    'SYSTEM',
    TIMESTAMP '2023-11-27 21:20:00',
    'ENG',
    'Bank Syariah Indonesia<development.bsi@ist.id>',
    'Routine Hajj Saving Success',
    NULL,
    NULL,
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <style type="text/css">
      ...
      .two-columns .content-value-black-bottom {
        padding-top: 10px;
        line-height: 0mm;
        border-bottom: 1px solid #e0e0e0;
        color: rgba(0, 0, 0, 0.96);
  ...
  '
      ...
      '              </td>
        ...
        <!-- table data (ini yang akan kita modified atau dipecah dulu, lalu create baru, lalu baru digabungkan)-->
        <tr>
          <td>
            <table width="100%">
              <tr>
      ...
      '   <td style="border-bottom: 1px solid #e0e0e0">
                          ...
                          <!-- Terminal -->
                          <tr>
                            <td class="content-label-no-border-bottom">
                              Terminal
                            </td>
                            <td class="content-value-no-border-bottom">
                              ${terminal}
                            </td>
                          </tr>
                   '
            ...
            <table width="100%">
              ...
              <tr>
                <td style="padding: 0 15px; text-align: center">
                  <a
                    href="https://bankbsi.id/facebook_bsi"
                  ...
                  <a
                    href="https://bankbsi.id/instagram_bsi"
                    style="color: #50b3ae00"
                    target="_blank"
                  >
                    <img
                  ...
                  <a
                    href="https://bankbsi.id/youtube_bsi"
                    style="color: #50b3ae00"
                    target="_blank"
                  >
                    <img
